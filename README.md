<div align="center">
  ...
  <img src="https://img.shields.io/github/last-commit/Books-QAQ/Windows-MCP" alt="Last Commit">
  <br>
...
mcp-name: io.github.Books-QAQ/Windows-MCP

## Updates

 

- Windows-MCP is available on [PyPI](https://pypi.org/project/windows-mcp/) (supports `uvx windows-mcp`)
  ...
  ```json
  {
    "mcpServers": {
      "windows-mcp": {
        ...
        "args": [
          "--directory",
          "C:\\Users\\<user>\\path\\to\\Windows-MCP",
          "run",
          "windows-mcp"
        ]
      }
...
[![Star History Chart](https://api.star-history.com/svg?repos=Books-QAQ/Windows-MCP&type=Date)](https://www.star-history.com/#Books-QAQ/Windows-MCP&Date)

## 👥 Contributors

Thanks to all the amazing people who have contributed to Windows-MCP! 🎉

<a href="https://github.com/Books-QAQ/Windows-MCP/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Books-QAQ/Windows-MCP" />
</a>
