...
1. **Fork the Repository**
   ...
   Click the "Fork" button on the [Windows-MCP repository](https://github.com/Books-QAQ/Windows-MCP) to create your own copy.
...
3. **Add Upstream Remote**
   ...
   ```bash
   git remote add upstream https://github.com/Books-QAQ/Windows-MCP.git
   ```
...
3. **Create Pull Request**
   ...
   - Go to the [Windows-MCP repository](https://github.com/Books-QAQ/Windows-MCP)
...
Instead, please:
1. Email the maintainers at [2895197998@qq.com](mailto:2895197998@qq.com)
2. Or use [GitHub Security Advisories](https://github.com/Books-QAQ/Windows-MCP/security/advisories)
...
- **Twitter/X**: Follow [@Books-QAQ](https://x.com/Books-QAQ)
- **GitHub Discussions**: Ask questions in [Discussions](https://github.com/Books-QAQ/Windows-MCP/discussions)
...
Made with ❤️ by the Books-QAQ community