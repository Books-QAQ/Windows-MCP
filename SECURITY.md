...
1. **Email**: Send details to the project maintainers at [2895197998@qq.com](mailto:2895197998@qq.com)
2. **GitHub Security Advisories**: Use the [GitHub Security Advisory](https://github.com/Books-QAQ/Windows-MCP/security/advisories) feature (preferred)
...
- Follow [@Books-QAQ](https://github.com/Books-QAQ) on X for updates
